...
public class GlideDisplay {
    ...
    public static void display(ImageView iv, String url) {
        DrawableRequestBuilder builder = Glide.with(iv.getContext()).load(url)
                .error(BG_DEF)
                .placeholder(BG_DEF)
                .crossFade(300);
    ...
    public static void displayWithNoFade(ImageView iv, String url) {
    ...
    public static void displayWithCenterCrop(final ImageView imageView, String url) {
    ...
    public static void displayWithCenterCrop(ImageView iv, File file) {
        DrawableRequestBuilder<File> builder = Glide.with(iv.getContext()).load(file).centerCrop()
                .placeholder(BG_DEF)
                .error(BG_DEF)
                .crossFade();
    ...
    public static void displayWithCenterCrop(ImageView iv, File file, int placeholderId, int width, int height) {
        DrawableRequestBuilder<File> builder = Glide.with(iv.getContext()).load(file).centerCrop()
    ...
    public static void displayWithCenterCrop(ImageView iv, File file, int placeholderId) {
        DrawableRequestBuilder<File> builder = Glide.with(iv.getContext()).load(file).centerCrop()
                .placeholder(placeholderId)
                .crossFade();
        fitThirdImageView(builder, iv);
    ...
    public static void displayWithFitCenter(ImageView iv, String url) {
    ...
    public static void displayWithFitCenterDef(ImageView iv, String url, int resImg) {
